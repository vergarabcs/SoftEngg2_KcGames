...
public class Calendar : MonoBehaviour
{
    ...
    public void UpdateCalandarDisplay()
    {
    ...
    void GenerateDOM()
    {
        ...
        int daysofWeekPrevMonth = 0;
        if (targetDate.Month != 1)
            daysofWeekPrevMonth = DateTime.DaysInMonth(targetDate.Year, targetDate.Month - 1);
        else
            daysofWeekPrevMonth = DateTime.DaysInMonth(targetDate.Year - 1, 12);
